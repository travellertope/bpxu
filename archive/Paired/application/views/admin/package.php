                                ...
                                <?php foreach ($features as $all_feature): ?>
                                  ...
                                  <div class="features flex-between">
                                    <div class="feature-item-left">
                                      ...
                                      }else{ echo "<b><i class='lnib lni-infinite'></i></b>";}; ?> 
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-sm-4 mr-auto"> 
                                          <?php if ($feature->is_limit == 1): ?>
                                            ...
                                            <?php if ($feature->slug != 'max-img-resulation'): ?>
                                              <div class="form-group">
                                            ...
                                            <?php else: ?>
                                              <div class="form-group mt-2">
                                                <select class="form-control" name="limits[]">
                                                  <option value="256" <?php if($feature->$slug == '256'){echo "selected";} ?>>256 x 256</option>
                                                  <option value="512" <?php if($feature->$slug == '512'){echo "selected";} ?>>512 x 512</option>
                                                  <option value="1024" <?php if($feature->$slug == '1024'){echo "selected";} ?>>1024 x 1024</option>
                                                </select>
                                              </div>
                                              <input type="hidden" name="ids[]" value="<?php echo html_escape($feature->id) ?>">
                                            <?php endif ?>
