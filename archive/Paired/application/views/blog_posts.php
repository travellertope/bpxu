	...
	<div class="container">
		...
		<div class="row align-items-center justify-content-center">
			<div class="col-lg-10 col-xl-8 text-center">
				...
				<form class="w-sm-90 mx-auto mx-lg-0 rounded-pill pl-4 pr-0 newsletter-form bg-white mb-4" action="<?php echo base_url('blogs') ?>" method="post">
