...
function bpu_ie_register_acf_fields() {
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array( 'key' => 'field_bpuie_social_instagram', 'label' => 'Instagram URL', 'name' => 'social_instagram', 'type' => 'url' ),
            array( 'key' => 'field_bpuie_social_linkedin', 'label' => 'LinkedIn URL', 'name' => 'social_linkedin', 'type' => 'url' ),
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            array( 'key' => 'field_bpuie_contact_eyebrow', 'label' => 'Eyebrow Text', 'name' => 'contact_hero_eyebrow', 'type' => 'text', 'default_value' => 'Contact' ),
            array( 'key' => 'field_bpuie_contact_heading', 'label' => 'Heading', 'name' => 'contact_hero_heading', 'type' => 'text', 'default_value' => 'Get in touch' ),
