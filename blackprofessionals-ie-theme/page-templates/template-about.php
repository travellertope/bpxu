 ...
 * Template Name: About
 *
 * Full "Our Story" page — navy hero, org story, Purpose & Vision,
 * Why We Exist, Impact, CTA band. All sections have hardcoded
 * defaults so the page is complete before any ACF data is entered.
 */
...
<header class="hero hero--navy">
    <div class="container">
        <h1><?php echo esc_html( bpu_ie_field( 'about_hub_heading', $post_id, 'Our Story' ) ); ?></h1>
        <p class="hero-sub"><?php echo esc_html( bpu_ie_field( 'about_hub_intro', $post_id, 'Black Professionals Ireland is a professional network committed to empowering Black professionals and students across Ireland — building community, creating opportunity, and driving systemic change.' ) ); ?></p>
    </div>
</header>
        ...
        <div class="impact-list">
            <?php foreach ( array_filter( explode( "\n\n", $impact_text ) ) as $para ) : ?>
                <div class="impact-item">
                    ...
                    <div><?php echo wp_kses_post( $para ); ?></div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
