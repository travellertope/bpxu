            ...
            <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/category/add')?>" role="form" novalidate>
              <div class="card-body">
                  ...
                  <div class="form-group">
                      <label><?php echo trans('icon') ?> <span class="text-danger">*</span></label>
                      <input type="text" class="form-control iconpicker" required="required" name="icon" value="<?php if(isset($category[0]['icon'])) {echo html_escape($category[0]['icon']);} ?>">
                  </div>
                      ...
                      <tbody>
                        <?php $i=1; foreach ($categories as $row): ?>
                          <tr id="row_<?php echo ($row->id); ?>">
                              ...
                              <td><?php echo html_escape($row->icon); ?></td>
